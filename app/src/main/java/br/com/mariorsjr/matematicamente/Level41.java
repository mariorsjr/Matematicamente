...
public class Level41 extends AppCompatActivity {
    ...
    public void generateQuestion(){
        ...
        if(correctAnswer>0) {
            randomMax = correctAnswer * 2;
            randomMin = -correctAnswer * 2;
        }else {
            randomMax = -correctAnswer * 2;
            randomMin = correctAnswer * 2;
        }
        ...
        for(int i=0; i < numberOfAnswers; i++){
            if(i == locationOfCorrectAnswer)
                ...
                do{
                    try{
                        wrongAnswer = random.nextInt(Math.abs(randomMax - randomMin)) + randomMin;
                    }catch (Exception e){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maximum = intent.getIntExtra("maximum", 20);
        //to guarantee that will included in random
        maximum++;
        minimum = intent.getIntExtra("minimun", 0);
    ...
    public void saveHighScore(){
        ...
        editor.putInt(getString(R.string.saved_high_score_level4), score);
        editor.commit();
    ...
    public int getHighScore(){
        SharedPreferences sharedPreferences = this.getSharedPreferences(getString(R.string.preference_file_key), Context.MODE_PRIVATE);
        return sharedPreferences.getInt(getString(R.string.saved_high_score_level4), 0);
    }
